...
_Por qué fallan las otras opciones_

- **Dagster (B)** – Técnicamente superior para linaje automático y compliance, pero el modelo open‑core bloquea SSO/RBAC detrás de paywall enterprise, violando el constraint de presupuesto.
- **Prefect (C)** – También usa open‑core y carece de linaje nativo, requiriendo implementación custom.
- **Kestra (D)** – Comunidad pequeña (<10 contribuidores) en zona de riesgo para viabilidad long‑term y también bloquea features de seguridad.

### EJEMPLO REAL

Uber ejecuta 450 K tareas diarias con Airflow, Stripe orquesta 150 K tasks daily, y LinkedIn maneja 10 K DAGs paralelos simultáneos — todos casos que demuestran la capacidad enterprise‑grade de Airflow para escalar con tareas heterogéneas.
